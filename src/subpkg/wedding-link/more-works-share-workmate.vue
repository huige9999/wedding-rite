    ...
    >
      <div class="cases-list">
        ...
        <div
          ...
          :key="index"
          class="cases-item"
          @click="navigateTo('work-detail-share-workmate',{workId:item.id})"
        >
          <!-- 封面 -->
          <div class="cover">
            <image
...
onShareAppMessage((options) => ({
  title: '我的作品已更新，快来查看吧',
  path: `/subpkg/wedding-link/work-detail-share-workmate?userId=${userInfo.value.id}&workId=${options.target.dataset.workId}&inviter=${tempUserInfo.value.id}`,
